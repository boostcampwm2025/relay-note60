...
- 퀘스트: AI로 다이어그램 혹은 플로우차트 그려보기
- 선택한 이유:
    - 항상 README를 작성할 때 도식화된 그림이 없어 설명하는 것에 있어 시간이 부족한 적이 많았습니다.
    - AI를 활용해서 설계한 다이어그램을 첨부하면 이러한 문제점을 완화시킬 수 있다고 생각하였습니다.
- 수행 계획:
    - 설계한 내용을 AI에게 설명해서 plantUML 문법으로 출력
    - 직접 구현한 코드를 AI에게 plantUML 문법으로 출력
    - 생성된 그림을 README에 첨부
...
- https://dolomite-teal-9fc.notion.site/week2-J203_-242c29ca6b7280b1b41bd973d3c3150e?source=copy_link\
...
S020_심관혁
- https://narrow-curler-55c.notion.site/2-242522a83d3b8045a17eeee922f1d2af
