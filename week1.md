...
<img width="400" height="350" src = "https://i.ibb.co/v4FpvPZM/image.png" >

## 👤 J191 이소망

- [x] 퀘스트 2. AI를 통해 나를 파악하기(자존감 챙기기!)

<img width="400" height="350" src = "https://i.ibb.co/rftTW8QG/image.png" >

## 👤 S024 이상유

- [x]  **퀘스트 4. AI를 활용해 더 깔끔한 문서화 도전하기 선택**

### 👀 미션 진행

미션 9일차의 `나만의체크포인트.md`를 AI에게 넘겨 개선을 부탁했습니다.

`나만의체크포인트.md` 선정 이유: 해당 미션의 파일에서 가장 마음에 안 들었던 파일이라서 선정했습니다.

```
프롬포트 요약: 목차, 예시, 요약을 추가해달라. 내용 변경 없이 가독성과 간결성을 지켜달라.
```

|  | 목차 | 예시 | 요약 |
| --- | --- | --- | --- |
| `ChatGPT` | 간결하게 작성 | 구현될 프로그램의 출력 예시문 추가 | 체크포인트의 전반적인 요약 |
| `Claude` | 비교적 자세함 | 학습과 관련된 포인트부터 주제마다 예시 추가 | 학습 목표, 진행 상황, 핵심 개념, 다음 단계를 포함한 요약 |

### 👀 느낀 점

사실 마음에 들게 개선되진 않았습니다.

체크포인트는 간결하게 필요한 것만 작성해야하는 파일인데, 퀘스트 요구사항에 맞는 파일로 `학습정리.md`나 `README.md`을 선택하는 게 더 괜찮다고 생각했습니다.

하지만 목차를 추가하는 부분과 다음 단계를 포함한 요약은 내 `학습정리.md`나 `README.md`에 적용하면 좋겠다고 느꼈습니다.
